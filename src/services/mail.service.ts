...
import { SENDER_MAIL, ENV_SGMAIL_KEY, VERIFY_EMAIL_TID } from "../utils/constant.util";
...
export class MailService {
    ...
    sendVerifyUserMail = async (userId: string, userVerifyRedirectUrl: string): Promise<void> => {
