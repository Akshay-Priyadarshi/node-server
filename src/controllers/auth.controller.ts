...
export class AuthController {
    constructor(private authService = new AuthService(), private mailService = new MailService()) {}
    ...
    signup = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            if (signedupUser) {
                const signedVerifyToken = getSignedJwtToken({ sub: signedupUser.id }, ENV_VERIFY_USER_SECRET);
